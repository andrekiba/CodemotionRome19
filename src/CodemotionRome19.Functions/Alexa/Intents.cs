namespace CodemotionRome19.Functions.Alexa
{
    ...
    {
        public const string SetResourceTypeIntent = "SetResourceTypeIntent";
        public const string AskForResourceNameIntent = "AskForResourceNameIntent";
        ...
        public const string BuildProjectIntent = "BuildProjectIntent";
